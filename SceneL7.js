...
//  gl.blendFunc(gl.SRC_ALPHA, gl.ONE_MINUS_SRC_ALPHA);
  ...
  this.cameraZSliderID = canvasID + "-z-slider";
  this.cameraZSlider = document.getElementById(this.cameraZSliderID);
...
Scene.prototype.Redraw = function() {
  ...
  camera.location[2] = this.cameraZSlider.value;
...
Scene.prototype.ResetCamera = function() {
  ...
  this.cameraZSlider.value = 10;

//  this.sSlider.value = 1;
//  SliderUpdate(this.sSliderID + "-output", 1);
//
//  this.tSlider.value = 1;
//  SliderUpdate(this.tSliderID + "-output", 1);

  this.perspectiveCheckBox.checked = this.camera.perspective;
  this.showTextureCheckBox.checked = true;
//  this.magLinearCheckBox.checked = true;
//  this.minMIPmapCheckBox.checked = true;
