...
function Sphere(modelName, gl, constructorParams) {
  ...
  this.textureURL = constructorParams[1];
  ...
  this.InitTexture(this.textureURL);
  ...
  this.vCameraPos = gl.getUniformLocation(shaderProgram, "cameraPos");
  ...
  this.cameraZslider = document.getElementById("gl-canvas-z-slider");
...
Sphere.prototype.Redraw = function(matrixStack, projectionMatrix, lightPositions,
  ...
  gl.uniform4fv(this.vCameraPos, flatten(vec4(0.0,0.0,this.cameraZslider.value,0.0)));
  
//  console.log(this.cameraZslider.value);
